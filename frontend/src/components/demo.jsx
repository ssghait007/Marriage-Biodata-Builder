...
const BiodataTemplate = ({ colorScheme, title }) => {
  ...
  return (
    <div className="flex-shrink-0 w-full sm:w-80 md:w-72 lg:w-80 mx-2 group">
      <h3 className="text-center font-semibold mb-2 text-gray-700 text-sm sm:text-base">{title}</h3>
      <div className={`relative w-full bg-gradient-to-br ${theme.gradient} p-2 sm:p-4 shadow-xl rounded-lg transition-all duration-300 group-hover:shadow-2xl group-hover:scale-105`}>
        ...
        <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-300 rounded-lg flex items-center justify-center opacity-0 group-hover:opacity-100 z-10">
          <button
            ...
            className={`${theme.button} text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-semibold shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 hover:shadow-xl text-sm sm:text-base`}
          >
            Select Template
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50 py-4 sm:py-8">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">Marriage Biodata Templates</h1>
          <p className="text-gray-600 text-sm sm:text-base">Choose from 10 beautiful color variations • Hover to select</p>
        </div>
        ...
        <div className="text-center mt-6 sm:mt-8">
          <p className="text-gray-600 text-xs sm:text-sm">
            <span className="block sm:hidden">Scroll down to view all templates • Tap to select</span>
            <span className="hidden sm:block">Scroll horizontally to view all templates • Hover over any template to select</span>
          </p>
        </div>
      </div>
    </div>
